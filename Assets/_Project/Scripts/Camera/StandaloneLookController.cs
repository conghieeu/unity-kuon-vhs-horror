...
public class StandaloneLookController : MonoBehaviour
{
    ...
    [Tooltip("Camera được sử dụng cho độ nhạy dựa trên FOV. Tự động tìm Camera.main nếu trống.")]
    public Camera MainCamera;

    [Tooltip("Transform gốc của player (chỉ cần cho kiểu RootForward).")]
    public Transform PlayerRoot;

    [Header("Input")]
    [Tooltip("Hành động đầu vào cho delta nhìn của chuột/cần điều khiển. Nếu trống, quay về Mouse.current delta.")]
