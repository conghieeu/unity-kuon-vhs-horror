...
Shader "Easy Decal/SSD/Standard DSSD Mask (Metallic)" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		Pass
		{
			...
			half4 frag(Varyings input) : SV_Target
			{
				...
				// The _SSDMasking was originally pushed into outNormal.w in deferred pass.
				// In URP Forward, we don't have direct access to G-Buffer.
				// We retain the properties to prevent pink material breakages.
