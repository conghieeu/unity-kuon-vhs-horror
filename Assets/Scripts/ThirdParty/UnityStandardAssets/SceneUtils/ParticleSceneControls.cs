...
// UnityStandardAssets.Effects removed - ParticleSystemMultiplier is no longer available
...
namespace UnityStandardAssets.SceneUtils
{
	public class ParticleSceneControls : MonoBehaviour
	{
		...
		// ParticleSystemMultiplier removed (UnityStandardAssets.Effects not available)
		...
		private void Update()
		{
			...
			if (s_Selected.mode != Mode.Trail || m_Instance == null)
			{
				...
				// ParticleSystemMultiplier no longer available; multiplier setting skipped
		...
		private void Select(int i)
		{
			...
			// m_ParticleMultiplier = s_Selected.transform.GetComponent<ParticleSystemMultiplier>(); // Not available
			multiply = 1f;
			if (clearOnChange)
			{
