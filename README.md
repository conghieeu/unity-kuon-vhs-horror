...
```
Assets/
├── 1-Scripts/                    # Scripts tự viết (custom gameplay)
│   ├── QuickItemAdder.cs         #   Thêm item nhanh vào inventory
│   └── UHFPSDialogueBridge.cs    #   Cầu nối UHFPS ↔ Pixel Crushers
│
├── 2-Prefabs/                    # Prefabs game
...
│
├── 3-Scenes/                     # Scenes
│   └── Hieu-Prototype.unity      #   Scene prototype chính
│
├── 4-Models/                     # 3D Models
│   └── lyingfbx-japanese-man/    #   Model nhân vật
│
├── Dialogs/                      # Dialogue Databases (Pixel Crushers)
│   ├── Dialogue Database NPC 1.asset
│   └── GlobalDatabase.asset
│
├── Data/                         # Game data
│   ├── Config/                   #   Cấu hình game
│   └── SavedGame/                #   Dữ liệu save game
│
├── ThunderWire Studio/UHFPS/     # ★ UHFPS Framework
│   ├── Content/
│   │   ├── Scripts/Runtime/
│   │   │   ├── Controllers/      #     Camera, Player, Items, Motion
│   │   │   ├── Core/             #     GameManager, AI, Inventory, Save, Input
│   │   │   ├── Interact/         #     Items, Hiding, Dynamic Objects
│   │   │   ├── Trigger/          #     Jumpscares, Cutscenes, Sounds
│   │   │   └── UI/               #     Menu, HUD, Options
│   │   ├── Prefabs/              #     UHFPS prefabs
...
│   ├── QFSW/                     #   Quantum Console
│   └── VHSPro_URP/               #   VHS/CRT effects
│
├── Japanese City Megapack/       # Asset: Thành phố Nhật Bản
├── Resources/Voice/              # Voice audio files
└── com.rlabrecque.steamworks.net/# Steamworks SDK
```
...
- **DialogueSystem (UHFPS)** — Dialogue built-in
...
4. Mở scene chính:
   ...
   ```
   Assets/3-Scenes/Hieu-Prototype.unity
   ```
